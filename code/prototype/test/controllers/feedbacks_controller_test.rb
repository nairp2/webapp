...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feedback" do
    assert_difference('Feedback.count') do
      post feedbacks_url, params: { feedback: { content: @feedback.content, title: @feedback.title, user_id: @feedback.user_id } }
    end
  ...
  test "should update feedback" do
    patch feedback_url(@feedback), params: { feedback: { content: @feedback.content, title: @feedback.title, user_id: @feedback.user_id } }
